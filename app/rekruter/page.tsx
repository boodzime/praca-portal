...
export default function RecruiterPage() {
  ...
  useEffect(() => { if (!isPending && !session?.user) router.replace('/sign-in?redirectTo=/rekruter') }, [isPending, session, router])
  ...
  if (isPending || !session?.user) return <main className="auth-shell"><p>Ładowanie panelu rekrutera...</p></main>
