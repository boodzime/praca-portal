...
const jobs: Record<string, { title: string; company: string; place: string; salary: string; tag: string; match: number; intro: string }> = {
  spawacz: { title: 'Spawacz TIG / MAG', company: 'MetalWorks Polska', place: 'Katowice · stacjonarnie', salary: '8 000–12 000 zł', tag: 'Produkcja', match: 94, intro: 'Dołącz do zespołu fachowców tworzących trwałe konstrukcje dla przemysłu.' },
