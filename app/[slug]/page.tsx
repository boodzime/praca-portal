...
import { jobBySlug, jobPlace } from '@/lib/jobs'

export function generateStaticParams() {
  return Object.keys(jobBySlug).map((slug) => ({ slug }))
}
